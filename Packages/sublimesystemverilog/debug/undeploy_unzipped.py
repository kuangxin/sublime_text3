...
print('[deploy] Undeployment to Packages ...')
...
time.sleep(2)
util.in_packages(src=SRC, dst=DST_UNZIPPED, action='uninstall', ignore_dirs=IGNORE_DIRS)
time.sleep(1)
...
print('[deploy] Undeployment to Packages DONE')